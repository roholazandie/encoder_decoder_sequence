...
def get_iterator(hyper_parameters,
    ...
    Iterator = namedtuple("Iterator", "iterator source_ids target_input_ids target_output_ids source_sequence_length target_sequence_length")
    (source_ids, target_input_ids, target_output_ids, source_sequence_length, target_sequence_length) = iterator.get_next()
...
def get_tables(source_vocab_file, target_vocab_file):
...
def get_datasets(train_source_file, train_target_file):
...
def create_embedding_for_encoder_and_decoder(share_vocab,
                                             source_vocab_size,
                                             target_vocab_size,
                                             source_embedding_size,
                                             target_embedding_size,
                                             source_vocab_file=None,
                                             target_vocab_file=None,
                                             source_embedding_file=None,
                                             target_embedding_file=None,
                                             ):

    if share_vocab:
        assert source_vocab_size == target_vocab_size
        embedding_encoder = create_or_load_embeddings("embedding",
                                                      source_vocab_file,
        ...
        embedding_encoder = create_or_load_embeddings("embedding_encoder",
                                                      source_vocab_file,
                                                      source_embedding_file,
                                                      source_vocab_size,
                                                      source_embedding_size,
        ...
        embedding_decoder = create_or_load_embeddings("embedding_decoder",
                                                      target_vocab_file,
